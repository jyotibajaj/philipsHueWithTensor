...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lampSwitchLayout = findViewById(R.id.lamp_switch_layout);
        lampSwitch = findViewById(R.id.lamp_switch);
        // Setup the UI
    ...
    private void changeLightState(final LightPoint light, boolean isChecked) {
     ...
     */
    private void randomizeLights(boolean isChecked) {
            ...
            public void run() {
                ...
                switch (state) {
                    ...
                    case Connected:
                        ...
                        bridgeDiscoveryButton.setVisibility(View.VISIBLE);
                        //Start camera view with switch
                        camera.setVisibility(View.VISIBLE);
                        lampSwitchLayout.setVisibility(View.VISIBLE);
                        discoveryLayout.setVisibility(View.GONE);
                        BridgeState bridgeState = bridge.getBridgeState();
                        List<LightPoint> lights = bridgeState.getLights();
                        for (final LightPoint light : lights) {
                            lampSwitch.setChecked(light.getLightState().isOn());
                            lampSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                                @Override
                                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                                    changeLightState(light, isChecked);
                                }
                            });
                            break;
                        }
